...
\begin{figure}[!ht]%htp]
    \centering
    \subfloat[Valeur absolue de la différence au carré]{\label{energie:sobel}\includegraphics[width=0.48\textwidth]{img/energy.png}}
    \hspace{0.030\textwidth}
...
\begin{figure}[!ht]%htp]
    \centering
    \subfloat[Masque avec la ligne de départ]{\label{ecum:steam}\includegraphics[width=0.48\textwidth]{img/steam.png}}
    \hspace{0.030\textwidth}
    \subfloat[Énergie cumulée]{\label{ecum:cum}\includegraphics[width=0.48\textwidth]{img/energy_cum.png}}
