...
% TODO: presentation biche : image résultat et positionnement de la figure...
De plus et pour terminer, voici des résultats sur un autre jeu d'image :
\begin{figure}[!ht]%htp]
    \centering
    \subfloat[Image source]{\label{resultsB:s}\includegraphics[width=0.28\textwidth]{img/fg_bamby.jpg}}
    \hspace{0.030\textwidth}
    \subfloat[Image cible]{\label{resultsB:c}\includegraphics[width=0.28\textwidth]{img/bg_bamby.jpg}}
    \hspace{0.030\textwidth}
    \subfloat[Résultat, avec la valeur absolue de la différence au carré pour l'énergie et les images en RGB]{\label{resultsB:r}\includegraphics[width=0.28\textwidth]{img/result_sobel.png}}
    \caption{Fusion des deux images suivant la couture minimale}
    \label{resultsB}
\end{figure}
